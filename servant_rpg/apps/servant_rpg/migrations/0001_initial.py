    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servant_rpg.grupo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combatente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servant_rpg.combatente')),
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servant_rpg.grupo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('combatente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servant_rpg.combatente')),
                ('encontro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='servant_rpg.encontro')),
            ],
        ),
    ]
