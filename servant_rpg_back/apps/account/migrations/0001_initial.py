# Generated by Django 5.1.4 on 2024-12-07 06:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.grupo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combatente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.combatente')),
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.grupo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('combatente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.combatente')),
                ('encontro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.encontro')),
            ],
        ),
    ]
